...
<c:set var="requestPath" value="/manager/requests/${request.id}" />
...
<t:generic>
    ...
    <div class="container main-content">
        <ol class="breadcrumb">
        	...
        	<li class="breadcrumb-item active"><a href="${managerUrl}"><spring:message code="requestsList.pageTitle" /></a></li>
        </ol>
